  ...
  return (
    <div className="page">
      ...
      <div className="grid-2">
        ...
        <Panel title="Level Progress" action={<Link className="button secondary" to="/workout-planner">Open Programmer</Link>}><XPBar xp={user.xp || 0} floor={xp.levelFloorXp} next={xp.nextLevelXp} /><div className="stat-grid" style={{ marginTop: '1rem' }}><div className="stat"><strong>{stats.totalXp}</strong><small>Total XP</small></div><div className="stat"><strong>{stats.workoutsThisWeek}</strong><small>Workouts This Week</small></div><div className="stat"><strong>{stats.streak}</strong><small>Day Streak</small></div><div className="stat"><strong>{stats.todaySteps || 0}</strong><small>Steps Today</small></div><div className="stat"><strong>{stats.stepMinutes || 0}</strong><small>Step Minutes</small></div></div></Panel>
      </div>
