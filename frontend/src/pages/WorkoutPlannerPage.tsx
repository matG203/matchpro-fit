        ...
        <>
          ...
          {completed ? (
            ...
            <>
              ...
              <ExerciseList exercises={workout.warmup} title="ðŸ”¥ Warm-Up" />
              <ExerciseList exercises={workout.mainSection} title="ðŸ’ª Main Session" />
              <ExerciseList exercises={workout.cooldown} title="â„ï¸ Cool-Down" />
