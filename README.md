...
- **Match Readiness %** â€” A transparent 0â€“100 score based on fitness consistency, cardio base, sleep, recovery, and test results
- **Player Card** â€” Football-style card starting at 45 Overall. Earn XP through workouts to reach Bronze â†’ Silver â†’ Gold â†’ Rare Gold â†’ Elite
- **XP System** â€” Earn XP from workouts, challenges, health logs, tests, and streaks
- **Avatar Customiser** â€” Build your footballer with XP-unlockable items (gold boots, chrome kit, elite poses, captain armband and more)
- **Smart Workout Planner** â€” Sessions generated based on your energy state, equipment, and goal
- **Daily & Weekly Challenges** â€” Auto-generated challenges with XP rewards
- **Leaderboards** â€” Friends and global leaderboards for XP, overall rating, steps, workouts
- **Wearables** â€” Fitbit OAuth, Apple Health ingestion endpoint, Google Health, Garmin structure, manual entry
- **Health Charts** â€” 30-day charts for steps, sleep, HR, weight, energy, active minutes
- **Daily Routine Checklist** â€” Customisable with XP reward for completion
- **Fitness Tests** â€” Log sprint times, push-ups, passing, shooting â€” tracks personal bests
...
4. Click on the Postgres service â†’ **Variables** tab
...
**Option A â€” Serve from Express (simplest):**
...
**Option B â€” Deploy frontend to Railway separately:**
...
**Option C â€” Vercel (recommended for frontend):**
...
â”œâ”€â”€ backend/
â”‚   â”œâ”€â”€ prisma/
â”‚   â”‚   â”œâ”€â”€ schema.prisma        # All database models
...
â”‚   â”‚   â”‚   â”œâ”€â”€ avatar.ts        # XP unlock system
â”‚   â”‚   â”‚   â”œâ”€â”€ playerCard.ts
â”‚   â”‚   â”‚   â”œâ”€â”€ wearables.ts
â”‚   â”‚   â”‚   â””â”€â”€ ...
â”‚   â”‚   â”œâ”€â”€ services/
â”‚   â”‚   â”‚   â”œâ”€â”€ xpService.ts     # XP, levelling, card tiers
â”‚   â”‚   â”‚   â”œâ”€â”€ readinessService.ts
â”‚   â”‚   â”‚   â”œâ”€â”€ workoutService.ts
â”‚   â”‚   â”‚   â””â”€â”€ challengeService.ts
â”‚   â”‚   â””â”€â”€ utils/
â”‚   â”‚       â””â”€â”€ prisma.ts
...
â”‚   â”‚   â”‚   â”œâ”€â”€ card/
â”‚   â”‚   â”‚   â”‚   â””â”€â”€ PlayerCard.tsx  # Flippable card with tiers + Elite animation
â”‚   â”‚   â”‚   â”œâ”€â”€ dashboard/
â”‚   â”‚   â”‚   â”‚   â”œâ”€â”€ ReadinessRing.tsx
â”‚   â”‚   â”‚   â”‚   â””â”€â”€ XPBar.tsx
â”‚   â”‚   â”‚   â””â”€â”€ layout/
...
|------|--------------|--------|
| Bronze | 45â€“59 | Bronze gradient |
| Silver | 60â€“74 | Silver gradient |
| Gold | 75â€“84 | Gold gradient |
| Rare Gold | 85â€“89 | Multi-tone gold |
| Elite âš¡ | 90+ | Animated shine + glow + pulse |
...
|----------|--------|-------|
| Fitbit | âœ… OAuth ready | Add `FITBIT_CLIENT_ID` and `FITBIT_CLIENT_SECRET` |
| Manual Entry | âœ… Fully working | Always available |
| Apple Health | ðŸ”§ Endpoint ready | Needs native iOS companion app using HealthKit |
| Garmin | ðŸ”§ Structure ready | Requires Garmin partner API approval |
| Google Fit | ðŸ”§ Endpoint ready | OAuth TODO |
